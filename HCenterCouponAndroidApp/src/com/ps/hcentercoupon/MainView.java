...
*/
	...
	public class ViewPagerAdapter extends PagerAdapter {
		...
		public void sendMail(String path) {
			...
			String link_val = "https://play.google.com/store/apps/details?id=com.ps.hcentercoupon";
			String body = "<a href=\"" + link_val + "\">" + link_val + "</a>";

			String link_val1 = "https://itunes.apple.com/WebObjects/MZStore.woa/wa/viewSoftware?id=956624177&mt=8";
			...
			emailIntent.putExtra(android.content.Intent.EXTRA_EMAIL,
					new String[] { "" });
			emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "שלחתי לך קופון משתלם של הום סנטר");
			emailIntent.putExtra(android.content.Intent.EXTRA_TEXT,
					"רוצים גם אתם ליהנות מקופונים משתלמים לחידוש ושיפוץ הבית? " + "\n\n"
							+ "הורידו את אפליקציית הום סנטר!" + "\n\n"
							+ androidtext + "\n\n" + Html.fromHtml(body) + "\n"
							+ iostext + "\n\n" + Html.fromHtml(body1));
	...
	private static void share(Session session) {
		...
		String description1 = "רוצים גם אתם ליהנות מקופונים משתלמים לחידוש ושיפוץ הבית? ";
		String description2 = "הורידו את אפליקציית הום סנטר!";

		String androidtextLink = "להורדה למכשירי   Androidלחצו כאן:";
		String iostextLink = "להורדה למכשירי iPhone לחצו כאן:";

		String link_val = "\n https://play.google.com/store/apps/details?id=com.ps.hcentercoupon";
		String body = "<a href=\"" + link_val + "\">" + link_val + "</a> \n";

		String link_val1 = "\n https://itunes.apple.com/WebObjects/MZStore.woa/wa/viewSoftware?id=956624177&mt=8";
