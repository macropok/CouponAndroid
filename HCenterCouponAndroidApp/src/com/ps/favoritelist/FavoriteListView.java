...
import com.ps.hcentercoupon.CommonUtilities;
import com.ps.hcentercoupon.StoreOnline;
import com.ps.hcentercoupon.policy_Activity;
		...
		new AsyncTask<Void, Void, Void>(){
			...
			protected Void doInBackground(Void... params) {
				...
				try {
					...
					if(Common.favCouponIds == null || Common.favCouponIds.isEmpty() || Common.favCouponIds.equalsIgnoreCase(""))
						return null;
